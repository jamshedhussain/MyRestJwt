package com.itz.MyRestjwt.config;
...
public class JWTConfig extends AuthorizationServerConfigurerAdapter{
	...
	@Value("${jamshed.oauth.tokenTimeout:3600}")
	...
	public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
		...
		clients.inMemory().withClient("jamshed").secret("secret").accessTokenValiditySeconds(expiration)
